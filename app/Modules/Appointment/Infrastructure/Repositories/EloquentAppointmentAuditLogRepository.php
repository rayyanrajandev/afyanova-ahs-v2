...
class EloquentAppointmentAuditLogRepository implements AppointmentAuditLogRepositoryInterface
{
    public function write(
        ...
        AppointmentAuditLogModel::query()->create([
    ...
    public function listByAppointmentId(
        ...
        $paginator = AppointmentAuditLogModel::query()
    ...
    private function toPagedResult(LengthAwarePaginator $paginator): array
    {
        return [
            'data' => array_map(
                static fn (AppointmentAuditLogModel $log): array => $log->toArray(),
                $paginator->items(),
            ),
            'meta' => [
