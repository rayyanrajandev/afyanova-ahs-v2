...
class ClinicalProcedureCatalogLookupService implements ClinicalProcedureCatalogLookupServiceInterface
{
    ...
    {
        $query
            ->where('catalog_type', ClinicalCatalogType::CLINICAL_PROCEDURE->value)
