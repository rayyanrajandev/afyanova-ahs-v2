...
class ListLaboratoryOrderAuditLogsUseCase
{
    ...
    public function execute(string $laboratoryOrderId, array $filters): ?array
    {
        $order = $this->laboratoryOrderRepository->findById($laboratoryOrderId);
        if (! $order) {
            return null;
        }
        ...
        return $this->auditLogRepository->listByLaboratoryOrderId(
