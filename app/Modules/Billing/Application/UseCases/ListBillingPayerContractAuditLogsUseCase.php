...
class ListBillingPayerContractAuditLogsUseCase
{
    ...
    {
        $contract = $this->repository->findById($billingPayerContractId);
        if (! $contract) {
            return null;
        }
        ...
        return $this->auditLogRepository->listByBillingPayerContractId(
