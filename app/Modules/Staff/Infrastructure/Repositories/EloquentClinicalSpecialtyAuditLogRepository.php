...
class EloquentClinicalSpecialtyAuditLogRepository implements ClinicalSpecialtyAuditLogRepositoryInterface
{
    public function write(
        ...
        ClinicalSpecialtyAuditLogModel::query()->create([
    ...
    public function listBySpecialtyId(
        ...
        $paginator = ClinicalSpecialtyAuditLogModel::query()
    ...
    private function toPagedResult(LengthAwarePaginator $paginator): array
    {
        return [
            'data' => array_map(
                static fn (ClinicalSpecialtyAuditLogModel $log): array => $log->toArray(),
                $paginator->items(),
            ),
            'meta' => [
