...
class ListStaffDocumentAuditLogsUseCase
{
    ...
    public function execute(string $staffProfileId, string $staffDocumentId, array $filters): ?array
    {
        ...
        return $this->auditLogRepository->listByStaffDocumentId(
