...
class ListStaffPrivilegeGrantAuditLogsUseCase
{
    ...
    public function execute(string $staffProfileId, string $staffPrivilegeGrantId, array $filters): ?array
    {
        ...
        $grant = $this->staffPrivilegeGrantRepository->findByIdForStaffProfile(
        ...
        return $this->auditLogRepository->listByStaffPrivilegeGrantId(
