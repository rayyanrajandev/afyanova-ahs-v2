...
class ListInpatientWardTaskAuditLogsUseCase
{
    ...
    public function execute(string $taskId, array $filters): ?array
    {
        ...
        return $this->auditLogRepository->listByTaskId(
            inpatientWardTaskId: $taskId,
            page: $page,
            perPage: $perPage,
            query: $query,
            action: $action,
