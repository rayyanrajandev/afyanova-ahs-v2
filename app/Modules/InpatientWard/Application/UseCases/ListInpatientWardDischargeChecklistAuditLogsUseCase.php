...
class ListInpatientWardDischargeChecklistAuditLogsUseCase
{
    ...
    public function execute(string $checklistId, array $filters): ?array
    {
        ...
        return $this->auditLogRepository->listByChecklistId(
            inpatientWardDischargeChecklistId: $checklistId,
            page: $page,
            perPage: $perPage,
            query: $query,
            action: $action,
