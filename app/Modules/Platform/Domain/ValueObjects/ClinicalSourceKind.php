...
enum ClinicalSourceKind: string
{
    ...
    {
        return [self::LABORATORY_ORDER, self::PHARMACY_ORDER, self::RADIOLOGY_ORDER, self::THEATRE_PROCEDURE];
    }
    ...
    {
        return match ($this) {
            self::LABORATORY_ORDER, self::PHARMACY_ORDER, self::RADIOLOGY_ORDER => true,
