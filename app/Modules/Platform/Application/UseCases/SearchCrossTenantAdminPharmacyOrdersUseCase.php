...
class SearchCrossTenantAdminPharmacyOrdersUseCase
{
    public function __construct(
        private readonly TenantRepositoryInterface $tenantRepository,
        private readonly CrossTenantAdminPharmacyOrderReadRepositoryInterface $pharmacyOrderReadRepository,
    ...
    public function execute(array $filters, ?int $actorId): ?array
    {
        ...
        if ($tenant === null) {
            $this->auditLogRepository->write(
                action: 'platform-admin.pharmacy-orders.search',
                operationType: 'read',
                actorId: $actorId,
                targetTenantId: null,
                targetTenantCode: $targetTenantCode !== '' ? $targetTenantCode : null,
                targetResourceType: 'pharmacy_order',
        ...
        $result = $this->pharmacyOrderReadRepository->searchByTenantId(
