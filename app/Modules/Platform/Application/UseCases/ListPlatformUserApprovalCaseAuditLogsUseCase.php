...
class ListPlatformUserApprovalCaseAuditLogsUseCase
{
    ...
    public function execute(string $approvalCaseId, array $filters): ?array
    {
        ...
        return $this->platformUserApprovalCaseRepository->listAuditLogs(
