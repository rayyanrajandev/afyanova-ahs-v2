...
use App\Modules\Platform\Domain\Repositories\CrossTenantAdminClinicalProcedureOrderReadRepositoryInterface;
use App\Modules\Platform\Domain\Repositories\TenantRepositoryInterface;

class SearchCrossTenantAdminClinicalProcedureOrdersUseCase
{
    public function __construct(
        private readonly TenantRepositoryInterface $tenantRepository,
        private readonly CrossTenantAdminClinicalProcedureOrderReadRepositoryInterface $clinicalProcedureOrderReadRepository,
    ...
    public function execute(array $filters, ?int $actorId): ?array
    {
        ...
        if ($tenant === null) {
            $this->auditLogRepository->write(
                action: 'platform-admin.clinical-procedure-orders.search',
                operationType: 'read',
                actorId: $actorId,
                targetTenantId: null,
                targetTenantCode: $targetTenantCode !== '' ? $targetTenantCode : null,
                targetResourceType: 'clinical_procedure_order',
        ...
        $result = $this->clinicalProcedureOrderReadRepository->searchByTenantId(
