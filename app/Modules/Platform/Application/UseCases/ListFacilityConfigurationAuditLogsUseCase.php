...
class ListFacilityConfigurationAuditLogsUseCase
{
    ...
    public function execute(string $facilityId, array $filters): ?array
    {
        ...
        return $this->auditLogRepository->listByFacilityId(
