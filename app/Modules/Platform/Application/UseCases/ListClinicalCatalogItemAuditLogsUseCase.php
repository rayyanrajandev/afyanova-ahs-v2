...
class ListClinicalCatalogItemAuditLogsUseCase
{
    ...
    public function execute(string $id, string $catalogType, array $filters): ?array
    {
        $item = $this->repository->findById($id);
        if (! $item || ($item['catalog_type'] ?? null) !== $catalogType) {
            return null;
        }
        ...
        return $this->auditLogRepository->listByClinicalCatalogItemId(
