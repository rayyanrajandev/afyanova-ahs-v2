...
class ListMultiFacilityRolloutAuditLogsUseCase
{
    ...
    public function execute(string $rolloutPlanId, array $filters): ?array
    {
        ...
        $actorId = $actorIdInput !== null && ctype_digit($actorIdInput) ? (int) $actorIdInput : null;
        ...
        return $this->auditLogRepository->listByRolloutPlanId(
