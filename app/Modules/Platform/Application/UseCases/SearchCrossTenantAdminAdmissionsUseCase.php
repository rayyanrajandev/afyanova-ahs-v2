...
class SearchCrossTenantAdminAdmissionsUseCase
{
    public function __construct(
        private readonly TenantRepositoryInterface $tenantRepository,
        private readonly CrossTenantAdminAdmissionReadRepositoryInterface $admissionReadRepository,
    ...
    public function execute(array $filters, ?int $actorId): ?array
    {
        ...
        $requestedSortKey = (string) ($filters['sortBy'] ?? 'admittedAt');
        $sortBy = $sortMap[$requestedSortKey] ?? 'admitted_at';
        ...
        if ($tenant === null) {
            $this->auditLogRepository->write(
                action: 'platform-admin.admissions.search',
                operationType: 'read',
                actorId: $actorId,
                targetTenantId: null,
                targetTenantCode: $targetTenantCode !== '' ? $targetTenantCode : null,
                targetResourceType: 'admission',
        ...
        $result = $this->admissionReadRepository->searchByTenantId(
        ...
        return [
            ...
            'meta' => [
                ...
                'filters' => [
                    ...
                    'from' => $fromDateTime,
                    'to' => $toDateTime,
                    'sortBy' => array_search($sortBy, $sortMap, true) ?: 'admittedAt',
