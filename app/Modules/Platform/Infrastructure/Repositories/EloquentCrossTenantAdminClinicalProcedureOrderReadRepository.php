...
class EloquentCrossTenantAdminClinicalProcedureOrderReadRepository implements CrossTenantAdminClinicalProcedureOrderReadRepositoryInterface
{
            ...
            ->when($query, function (Builder $builder, string $searchTerm): void {
                ...
                $builder->where(function (Builder $nestedQuery) use ($like): void {
                    $nestedQuery
                        ...
                        ->orWhere('procedure_description', 'like', $like);
                });
            })
