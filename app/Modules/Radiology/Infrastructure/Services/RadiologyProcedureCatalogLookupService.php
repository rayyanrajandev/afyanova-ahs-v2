...
class RadiologyProcedureCatalogLookupService implements RadiologyProcedureCatalogLookupServiceInterface
{
    ...
    {
        $query
            ->where('catalog_type', ClinicalCatalogType::RADIOLOGY_PROCEDURE->value)
