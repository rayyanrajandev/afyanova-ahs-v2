...
function updateMsdSubmitImmediately(value: boolean | 'indeterminate') {
    ws.msdOrderForm.submitImmediately = value === true;
}
</script>
        ...
        <SheetContent side="right" variant="form" size="4xl">
            ...
            <div class="px-6 py-4 grid gap-4">
                ...
                <div class="flex items-center gap-2">
                    <Checkbox id="msd-submit-now" :model-value="ws.msdOrderForm.submitImmediately" @update:model-value="updateMsdSubmitImmediately" />
