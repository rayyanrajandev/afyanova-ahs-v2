...
export type SupplyChainNextActionTone = 'danger' | 'warning' | 'success' | 'neutral';

export type SupplyChainNextAction = {
    key: string;
    label: string;
    value: string | number;
    helper: string;
    icon: AppIconName;
    tone: SupplyChainNextActionTone;
    target: SupplyChainSection;
};
...
export function nextActionClass(tone: SupplyChainNextActionTone): string {
