...
const routeAccessRules: RouteAccessRule[] = [
    ...
    {
        pathPrefix: '/inventory-procurement/categories',
        requiredPermissions: [
    ...
    {
        pathPrefix: '/billing-consultation-mappings',
        requiredPermissions: ['billing.consultation-mappings.read'],
    },
    {
