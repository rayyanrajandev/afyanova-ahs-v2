...
import { useDirectServicePatientDirectory } from './useDirectServicePatientDirectory';
...
describe('useDirectServicePatientDirectory', () => {
    beforeEach(() => {
        vi.restoreAllMocks();
    });
    ...
    it('hydrates each unique patient id once', async () => {
        ...
        const directory = await mount(() => useDirectServicePatientDirectory(ids));
