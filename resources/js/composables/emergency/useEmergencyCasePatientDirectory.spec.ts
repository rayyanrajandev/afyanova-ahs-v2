...
import { useEmergencyCasePatientDirectory } from './useEmergencyCasePatientDirectory';
...
describe('useEmergencyCasePatientDirectory', () => {
    beforeEach(() => {
        vi.restoreAllMocks();
    });
    ...
    it('hydrates each unique patient id once', async () => {
        ...
        const directory = await mount(() => useEmergencyCasePatientDirectory(ids));
