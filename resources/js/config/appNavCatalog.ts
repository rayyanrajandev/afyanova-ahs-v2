...
export const appNavCatalog: AppNavCatalogItem[] = [
    ...
    },
    {
        ...
        helpNote: 'Take cash/check/mobile payments against invoices at the counter',
    },
    {
        title: 'POS counter',
        href: '/pos',
        iconName: 'receipt',
        section: 'billing',
        subGroup: 'point_of_sale',
        permissionPrefixes: ['pos.registers.'],
        helpNote: 'General retail sales (gift shop, OTC supplies, non-clinical items)',
    },
    {
        title: 'Walk-in payments',
        href: '/pos/frontdesk-quick',
        iconName: 'layout-list',
        section: 'billing',
        subGroup: 'point_of_sale',
        permissionPrefixes: ['pos.frontdesk-quick.'],
        helpNote: 'Pay for ordered lab, pharmacy, or radiology services at the counter',
    },
    {
        title: 'Cafeteria POS',
        href: '/pos/cafeteria',
        ...
        section: 'billing',
        subGroup: 'point_of_sale',
        permissionPrefixes: ['pos.cafeteria.'],
